...
export const App = (): JSX.Element => {
  ...
  const {
    ...
    appendExecutionLog,
    clearExecutionState,
    // Passing down specific states needed for context menu logic inside the hook
    currentGraphId, // for node filtering in context menu
    currentParentNodeType, // for node filtering in context menu
  });
  ...
  const handleSaveAndClearGraph = () => {
    handleSaveGraph();
    executeClearGraph(); // This will now also call closeClearGraphModal
  };
  ...
  return (
    <div className="flex h-screen bg-[#24272E] text-[rgba(255,255,255,0.87)] font-sans">
      {/* Left Controls Panel */}
      <div className="w-[300px] flex-shrink-0 border-r border-[rgba(255,255,255,0.08)] flex flex-col max-h-screen neumorphic-panel">
        ...
        <div className="flex-grow overflow-y-auto min-h-0 p-3">
         ...
         <div className="p-3 border-t border-[rgba(255,255,255,0.08)] space-y-2 flex-shrink-0">
            ...
            <div className="flex space-x-2">
                ...
                >
                    <ArrowUturnLeftIcon className="w-4 h-4 mr-1.5" /> Undo
                </button>
                <button
                ...
                >
                    <ArrowUturnRightIcon className="w-4 h-4 mr-1.5" /> Redo
                </button>
            </div>
            ...
            <div className="flex space-x-2">
                ...
                >
                    <DocumentDuplicateIcon className="w-4 h-4 mr-1.5" /> Copy
                </button>
                <button
                ...
                >
                   <ClipboardDocumentIcon className="w-4 h-4 mr-1.5" /> Paste
                </button>
            </div>
        </div>
        <DebugControls
        ...
        <div className="p-4 flex flex-col space-y-3 flex-grow min-h-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-1 items-start flex-shrink-0 p-3 rounded-lg neumorphic-panel">
                ...
                <button
                    ...
                    className={`self-end w-full h-9 flex items-center justify-center px-3 py-1.5 text-sm font-medium rounded-md primary-action-button focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#2D3039] focus:ring-[#a855f7]`}
                >
      ...
      <div className="w-[380px] flex-shrink-0 border-l border-[rgba(255,255,255,0.08)] flex flex-col max-h-screen neumorphic-panel">
         <div className="p-3 border-b border-[rgba(255,255,255,0.08)] space-y-2 flex-shrink-0">
            <h3 className="text-xs font-semibold text-[rgba(255,255,255,0.6)] mb-1.5 tracking-wider uppercase">Graph Actions</h3>
             <div className="space-y-2">
                <button
                    ...
                    className={`w-full flex items-center justify-center px-3 py-2 text-sm font-medium rounded-md turquoise-action-button`}
                ...
                >
                 ...
                 <div className="flex items-center justify-between pt-2">
                    ...
                    <label htmlFor="sequenceModeToggle" className="switch" title="Toggle visual sequence mode (future feature)">
                        <input
                            type="checkbox"
                            id="sequenceModeToggle"
                            checked={isSequenceModeActive}
                            onChange={(e) => setIsSequenceModeActive(e.target.checked)}
                        />
                 ...
                 <div className="flex items-center justify-between pt-1">
                    ...
                    <label htmlFor="focusModeToggle" className="switch" title="Toggle Focus Mode (dims non-compatible nodes in Controls Panel)">
                        <input
                            ...
                            onChange={(e) => setIsFocusModeActive(e.target.checked)}
                        />
                        <span className="slider"></span>
                    </label>
                </div>
         ...
         <div className="flex-grow overflow-y-auto min-h-0">
            {selectedNodeForInspector ? (
                ...
                {selectedNodeIds.length > 1 ? `${selectedNodeIds.length} selected. Edit individually.` : "Select a node to inspect."}
                {selectedNodeIds.length === 0 && currentGraphId === 'root' && <p className="mt-2">Add nodes from the Controls Panel on the left.</p>}
                </div>
            )}
         </div>
